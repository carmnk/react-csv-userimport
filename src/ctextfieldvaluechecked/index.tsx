...
const TextFieldValueChecked = forwardRef(
  (props: TextFieldVC_Props, ref: React.RefObject<HTMLInputElement>) => {
    ...
    const isErrorInt =
      isError !== undefined &&
      (typeof isError === "boolean" || typeof isError === "function")
        ? isError
        : false;
    ...
    const InputRefCombined: CRefObject<
      HTMLInputElement
    > | null = useCombinedRefs(inputRef, InputRefInner);
    ...
    useEffect(() => {
      ...
      if (isRefValid(InputRefCombined))
        if (InputRefCombined !== null && InputRefCombined.current !== null)
          InputRefCombined.current.addEventListener("keyup", (e) => {
            onKeyUp(e);
          });
    ...
    useEffect(() => {
      ...
      if (props.value !== undefined) CheckIsError(props.value);
    }, [props.isError]);
                    ...
                    onClick={() => {
                      ...
                      clipProm
                        ...
                        .catch((reason) => {
                          ...
                          console.log(
                            `Handle rejected Clipboard-reading promise (${reason}) here.`
                          );
                          alert(
                            "Error reading clipboard. Please make sure to grant permission to access clipboard."
                          );
                        });
                    }}
                  >
